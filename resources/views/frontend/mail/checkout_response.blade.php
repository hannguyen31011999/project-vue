            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Cảm ơn bạn đã sử dụng dịch vụ đăng tin bên chúng tôi</td>
                    </tr>
                  </table>
                        ...
                        <table class="status" bgcolor="#fffeea" cellspacing="0">
                          <tr>
                            <td class="status-cell">
                              Mã đơn hàng của bạn: <b> {{ $code }}</b> <br> {{ $mess }}
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Hướng dẫn tra cứu</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Đầu tiên bạn nhấn vào đường link phía đưới để chuyển trang đến trang
                              tra cứu lịch sử đăng tin.Trong trang lịch sử đăng tin bạn nhập mã hóa
                              đơn và kiểm tra xem lịch sử đăng tin và giá tiền.
                            </td>
                          </tr>
                        </table>
                        ...
                        <![endif]--><a href="http://localhost:8000/tra-cuu/hoa-don"
                        style="background-color:#41CC00;background-image:url(https://www.filepicker.io/api/file/N8GiNGsmT6mK6ORk00S7);border:1px solid #407429;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;line-height:38px;text-align:center;text-decoration:none;width:210px;-webkit-text-size-adjust:none;mso-hide:all;">Liên kết tại đây</a></div>
