            ...
            <div id="cardCollpase4" class="collapse show">
              <div class="card-body">
                <div class="todoapp">
                  ...
                  <ul
                    class="list-group slimscroll todo-list"
              ...
              <div class="card-body">
                <ul class="list-group list-group-lg">
                  <li class="list-group-item border-0 pt-2">
                    ...
                    <span class="float-right badge badge-primary mt-2"
                      >CEO</span
                    >
                  ...
                  <li class="list-group-item border-0">
                    ...
                    <span class="float-right badge badge-info mt-2"
                      >Webdesigner</span
                    >
                  ...
                  <li class="list-group-item border-0">
                    ...
                    <span class="float-right badge badge-pink mt-2"
                      >Programmer</span
                    >
                  ...
                  <li class="list-group-item border-0">
                    ...
                    <span class="float-right badge badge-warning mt-2"
                      >Webdeveloper</span
                    >
                    <a href="">Jannie Dvis</a>
                  </li>
