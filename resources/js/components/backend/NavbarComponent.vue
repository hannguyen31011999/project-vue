    ...
    <ul class="list-unstyled topnav-menu float-right mb-0">
        ...
        <li class="dropdown notification-list">
            ...
            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                ...
                <!-- item-->
                <a href="javascript:void(0);" @click.prevent="logoutUser()" class="dropdown-item notify-item">
...
export default {
    ...
    created(){
        axios.get(getUserUrl + getToken())
        .then(res => {
            this.userLogin.fullname = res.data.user.fullname;
        })
        .catch(e => {
