...
export default {
    ...
    methods:{
        getListProduct(keyword,url){
            if(keyword===null){
                axios.get(apiDomainUser + 'home/seach/list' + '?url=' + url)
                .then(res => {
                    if(res.data.status){
                ...
                axios.get(apiDomainUser + 'home/seach/list' + '?url=' + url + '&keyword=' + keyword)
                .then(res => {
                    if(res.data.status){
                      if(res.data.data.last_page === 1){
                        $("#last").addClass("disabled");
        ...
        getData(page) {
          if(this.keyword!=''){
            axios.get(apiDomainUser + 'home/seach/list?page=' + page + '&keyword=' + this.keyword + '&url=' + this.url)
            .then((res) => {
              this.pagination = res.data.data;
          ...
          {
            axios.get(apiDomainUser + 'home/seach/list?page=' + page + '&url=' + this.url)
            .then((res) => {
              this.pagination = res.data.data;
              this.products.id = null;
              this.products = res.data.data.data;
    ...
    created(){
        if(this.$route.query.q===undefined){
          ...
          this.getListProduct(null,this.url);
        }else{
          this.keyword = localStorage.getItem('urlSeach');
          this.url = window.location.pathname.split('/')[2];
          this.getListProduct(this.keyword,this.url);
        }
    },
    mounted(){
